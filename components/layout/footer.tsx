  ...
  return (
    <footer className="p-5 bg-slate-200 mt-4 text-sm">
      <div className="max-w-[1000px] mx-auto flex max-sm:flex-col gap-4 justify-between">
        ...
        <div>
          <p className="mb-1">Recipe Box is independantly created by <Link className={linkClass} href="https://aaronrutherford.dev">Aaron Rutherford <FontAwesomeIcon icon={faExternalLink} className="pl-1" /></Link>.</p>
